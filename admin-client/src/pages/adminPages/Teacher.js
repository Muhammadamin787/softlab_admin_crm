...
class Teacher extends Component {
    ...
    render() {
        ...
        const {dispatch, attachmentId, secondPage, showModal, deleteModal, loading, courseCategories, teachers, selectItems, spec, selectItemsFromSpec, regions} = this.props;
                                ...
                                <div className={"w-100 border p-2 rounded"}>
                                    <Row>
                                        <Col>
                                            ...
                                            <AvField className={'form-control'} label={"Telefon raqam"} type="number"
                                                     name="phoneNumber"
